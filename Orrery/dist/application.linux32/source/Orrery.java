...
public class Orrery extends PApplet {
...
class Graph {
  int[] colors = {
    ...
    0xffc3ff00, 0xffffef00, 0xffff9b00, 0xffff0000, 0xffe60000, 0xffcc0000, 
    0xffb30000, 0xff990000, 0xff800000, 0xff660000, 0xff4d0000, 0xff330000, 
  };
  int[] wavelengths = {
...
class LineGraph extends Graph {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "Orrery" };
    if (passedArgs != null) {
